    ...
    def __init__(self, root: "Root", binance: BinanceFuturesClient, bitmex: BitmexClient, *args, **kwargs):
        ...
        self._base_params = [
            ...
            {"code_name": "timeframe", "widget": tk.OptionMenu, "data_type": str, "values": self._all_timeframes,
             "width": 7},
            {"code_name": "balance_pct", "widget": tk.Entry(self, width=15, fg=FG_COLOR, justify=tk.CENTER,
                                                            insertbackground='white', bg=BG_COLOR_2), "data_type": float, "width": 15},
            {"code_name": "take_profit", "widget": tk.Entry(self, width=15, fg=FG_COLOR, justify=tk.CENTER,
                                                            insertbackground='white', bg=BG_COLOR_2), "data_type": float, "width": 15},
            {"code_name": "stop_loss", "widget": tk.Entry(self, width=15, fg=FG_COLOR, justify=tk.CENTER,
                                                            insertbackground='white', bg=BG_COLOR_2), "data_type": float, "width": 15},
